//
// Modify the program.
// - Ask the user to input the type of a shape
// - Ask the user to input the measures 
//   (e.g., side length, radius) of the shape
// - Compute the result(s)
// - Show the result(s)
// - Ask the user to repeat or to quit the program. 
//
#include <iostream>
#include <iomanip>
using namespace std;
...
//as it has at least one member function which is undefined.
class SHAPE {
private:
protected:
